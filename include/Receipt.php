...
<html lang="en">
  ...
  <body>
    ...
    <p>Number of Days: <?= htmlspecialchars($booking['days']) ?></p>
    <p>Booking Date: <?= htmlspecialchars($booking['checkin']) ?></p>
    <p>Package: <?= htmlspecialchars($booking['package']) ?></p>
    <p>Number of Guests:<?= htmlspecialchars($booking['guests']) ?></p>
    <p>Total Amount: <?= htmlspecialchars($booking['amount']) ?></p>
    <p>Payment Method: <?= htmlspecialchars($booking['payment']) ?></p>
    <p>Reference Number: <?= htmlspecialchars($booking['Reference']) ?></p>
