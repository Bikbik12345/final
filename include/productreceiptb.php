...
$stmt = $pdo->prepare("SELECT * FROM boracaymarket WHERE id = ?");
...
<html lang="en">
  ...
  <body>
    ...
    <p>Product ID: <?= htmlspecialchars($product['id']) ?></p>
    <p>Name: <?= htmlspecialchars($product['name']) ?></p>
    <p>Email: <?= htmlspecialchars($product['email']) ?></p>
    <p>Phone: <?= htmlspecialchars($product['phone']) ?></p>
    <p>Address: <?= htmlspecialchars($product['address']) ?></p>
    <p>Product: <?= htmlspecialchars($product['Product']) ?></p>
    <p>Total Amount: <?= htmlspecialchars($product['amount']) ?></p>
    <p>Payment Method: <?= htmlspecialchars($product['payments']) ?></p>
    <p>Reference Number: <?= htmlspecialchars($product['reference']) ?></p>
